...
import { uploadManuscript } from '../middlewares/upload.js';
...
router.post('/', submissionLimiter, uploadManuscript.single('manuscript'), submissionValidation, handleValidation, createSubmission);
